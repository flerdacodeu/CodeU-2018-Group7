...
class TestInput(unittest.TestCase):
    ...
    def test_empty_state(self):
        ...
        end_state = []
        path_finder = PathFinder(start_state, end_state)
        moves = path_finder.compute_efficient_moves(start_state, end_state)
    ...
    def test_apply_to_empty(self):
        ...
        start_state = []
        moves = [(1, 2), (0, 1), (3, 0)]
        path_finder = PathFinder(start_state)
        self.assertRaises(IndexError, lambda: path_finder.apply_moves(start_state, moves))
    ...
    def test_apply_empty_moves(self):
        ...
        start_state = [1, 2, 0, 3]
        path_finder = PathFinder(start_state)
        self.assertEqual(path_finder.apply_moves(start_state, moves), start_state)
